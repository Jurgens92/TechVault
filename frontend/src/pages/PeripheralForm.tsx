...
export function PeripheralForm({ editId, onSave, onCancel, isModal }: PeripheralFormProps = {}) {
  ...
  const loadLocations = async () => {
    ...
    try {
      ...
      // If creating a new peripheral (not editing), pre-select the first location
