    ...
    <div className="p-6 max-w-3xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="border border-border rounded-lg p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium mb-2">Last Backup Date</label>
              <input
                type="datetime-local"
                value={formData.last_backup_date}
                onChange={(e) => setFormData({ ...formData, last_backup_date: e.target.value })}
                className="w-full px-3 py-2 border border-input rounded-md bg-background"
              />
            </div>
            <div>
              <label className="block text-sm font-medium mb-2">Next Backup Date</label>
              <input
                type="datetime-local"
                value={formData.next_backup_date}
                onChange={(e) => setFormData({ ...formData, next_backup_date: e.target.value })}
                className="w-full px-3 py-2 border border-input rounded-md bg-background"
              />
            </div>
          </div>
        ...
        <div className="border border-border rounded-lg p-6 space-y-4">
          <h2 className="text-lg font-semibold">Cost Information</h2>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-2">Cost Period</label>
              <select
                value={formData.cost_period}
                onChange={(e) => setFormData({ ...formData, cost_period: e.target.value as Backup['cost_period'] })}
                className="w-full px-3 py-2 border border-input rounded-md bg-background"
              >
